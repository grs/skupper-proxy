    ...
    request.on('end', function () {
        ...
        self.client.request(message_out).then(function (messages_in) {
            if (messages_in.length === 0) {
                ...
                var boundary_marker = 'skupper-boundary';
                ...
                response.end();
                metrics.http_ingress_request(self.metrics, client_ip(request), request.method, response.statusCode, message_out.body.length, response_bytes, elapsed(start));
            }
